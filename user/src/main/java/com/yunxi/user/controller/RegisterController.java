...
public class RegisterController {
    ...
    @HystrixCommand(
            ...
            commandKey = "register",// 接口名称，默认为方法名
            ...
            },fallbackMethod = "registerFallbackMethod"
    )
    @ApiOperation(value="用户注册")
    @PostMapping("/register")
    public BaseResponse register(@RequestBody RegisterReqVO reqVO){
        return BaseResponse.result(userService.register(reqVO));
    }

    private BaseResponse registerFallbackMethod(RegisterReqVO reqVO) {
        return BaseResponse.fail("用户注册方法执行失败啦，入参：" + reqVO.toString());
    }
