...
import com.yunxi.user.util.theadpool.CustomTask;
import com.yunxi.user.util.theadpool.ThreadPoolExecutorUtil;
        ...
        return new ThreadPoolExecutorUtil(
                ...
                new RejectedExecutionHandler() {//自定义拒绝策略
                    ...
                    public void rejectedExecution(Runnable r, java.util.concurrent.ThreadPoolExecutor executor) {
                        ...
                        // 举个例子：假设有100万条数据被拒绝了100条，可以直接执行重试机制，因为拒绝的占比非常小，如果100万条数据被拒绝了10条数据甚至更多，说明线程池参数定义有问题或者有其他性能问题，这是不建议走重试机制，而是进行报警人工干预
